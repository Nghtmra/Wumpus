...
public class HuntTheWumpus extends JPanel implements KeyListener {
    ...
    private boolean mobile_wumpus = true;
    private int wumpus_move_chance = 1;
    ...
    // Collections
    private List<Integer> bats_list = new ArrayList<>();
    private List<Integer> pits_list = new ArrayList<>();
    private List<Integer> arrows_list = new ArrayList<>();
    
    // Cave mapping
    private Map<Integer, int[]> cave = new HashMap<>();
...
Press the <SHIFT> key and an arrow key to use your flashlight at the Wumpus.
    ...
    private void loadImages() {
        try {
            ...
            arrow_img = ImageIO.read(new File("images/flashlight.png"));
            ...
            arrow_img = new BufferedImage(50, 50, BufferedImage.TYPE_INT_RGB);
